	      ...
	      <div class="col-md-8">
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Calibration Control System</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <div class="row">
                      ...
                      <div class="col-lg-4 col-xs-6">
                        ...
                        <div class="small-box bg-yellow">
                          <div class="inner">
                            <h3>Overdue</h3>
                            <p>Equipment Overdue Notice</p>
                          </div>
                          <div class="icon" style="margin-top:10px">
                            <i class="glyphicon glyphicon-alert"></i>
                          </div>
                          <a href="report_overdue.php" class="small-box-footer">
                            Click <i class="fa fa-arrow-circle-right"></i>
                          </a>
                        </div>
                      </div><!-- ./col -->
					 ...
					 <div class="col-lg-4 col-xs-6">
                        ...
                        <div class="small-box bg-orange">
                          ...
                          <a href="manufacturer.php" class="small-box-footer">
                            Click <i class="fa fa-arrow-circle-right"></i>
                          </a>
                        </div>
                      </div><!-- ./col -->
					   ...
					   <div class="col-lg-4 col-xs-6">
                        ...
                        <div class="small-box bg-blue">
                          ...
                          <a href="location.php" class="small-box-footer">
                            Click <i class="fa fa-arrow-circle-right"></i>
                          </a>
                        </div>
                      </div><!-- ./col -->
